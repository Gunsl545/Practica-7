...
public class QuickSort {
    ...
    public static void main(String[] args) {
       ...
       Random r = new Random();
       System.out.print("De que tama�o quiere que sea el arreglo a ordenar? ");
       int n = sh.nextInt();
	...
	//EL PIVOTE SE REACOMODA EN LA POSICIO�N EN LA QE TANTO i COMO j SON EL MISMO VALOR, DEJANDO DEL LADO DERECHO A LOS N�MEROS MAYORES AL PIVOTE
